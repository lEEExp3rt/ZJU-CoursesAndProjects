...
## 任务：建立CPU测试环境（基本SOC系统）

1. 新建工程
2. 导入所有子模块
3. 根据原理图进行Verilog的`CSSET`顶层模块编写
4. 存储器IP核重新初始化
5. 生成比特流
6. 下板验证
...
![文件结构](image-20240321105634813.png)

---

### 生成比特流

使用课件提供的`A7.xdc`进行引脚约束，并生成比特流

![生成比特流](image-20240321110410433.png)
...
![image-20240321153328558](image-20240321153328558.png)

`SW[7:5] = 111`，第一条指令地址显示为<u>00000000</u>

![image-20240321153521202](image-20240321153521202.png)

`SW[7:5]=010`，指令为<u>00100093</u>

VGA显示如下：

![image-20240321190059998](image-20240321190059998.png)

#### 第二条指令

手拨`SW[10]`使得时钟前进一步，`SW[7:5]=111`，可得第二条指令地址为<u>00000004</u>

![image-20240321153729005](image-20240321153729005.png)

`SW[7:5]=010`，可得第二条指令为<u>00102133</u>

![image-20240321153837368](image-20240321153837368.png)

VGA显示结果如下：

![image-20240321190236112](image-20240321190236112.png)

#### 指令分析

* `pc`显示的是指令地址
* `inst`显示的是指令内容
* `dmem_i_data`为斐波那契数列单项数值
* `dmem_addr`为取出数据的地址
* `alu_res`为最终斐波那契数列的求和结果

`dmem_i_data`为1,1,2,3,5,8,...的斐波那契数列
...
memory_initialization_vector=00100093 00100133 00109093 00110133 00109093 00110133 00109093 00110133 00109093 00110133 00109093 00110133 00109093 00110133 00109093 00110133 00109093 00110133 00109093 00110133 00109093 00110133 00109093 00110133 00109093 00110133 00109093 F8000AE3;
```
