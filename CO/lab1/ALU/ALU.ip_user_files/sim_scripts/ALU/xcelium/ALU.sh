...
design_libs_elab="-libname xil_defaultlib -libname xlslice_v1_0_2 -libname xlconcat_v2_1_4 -libname xlconstant_v1_1_7 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xil_defaultlib xlslice_v1_0_2 xlconcat_v2_1_4 xlconstant_v1_1_7)
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ALU xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ALU -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ALU_sc.so .tmp_log xcelium_lib waves.shm c.obj)
